...
export const en = {
  ...
  locationsPage: {
    eyebrow: "Locations",
    title: "Find Hegazy Group.",
    lead: "Our head office and primary fulfillment hub are in Alexandria, Egypt, with a second fulfillment region in Cairo.",
    headOfficeLabel: "Head office",
    fulfillmentLabel: "Fulfillment regions",
    fulfillmentBody: "Cairo and Alexandria, Egypt.",
    addressLabel: "Address",
    hoursLabel: "Business hours",
    hours: "Saturday–Thursday, 9:00 AM–4:00 PM · Friday closed",
    directions: "Get Directions",
