    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/resources/technical-specifications", changefreq: "monthly", priority: "0.5" },
          { path: "/resources/selection-guides", changefreq: "monthly", priority: "0.5" },
          { path: "/locations", changefreq: "monthly", priority: "0.6" },
          { path: "/contact", changefreq: "monthly", priority: "0.8" },
          { path: "/quote", changefreq: "monthly", priority: "0.8" },
          { path: "/catalog", changefreq: "monthly", priority: "0.5" },
